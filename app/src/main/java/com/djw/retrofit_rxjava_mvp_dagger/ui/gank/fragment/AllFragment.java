...
import com.djw.retrofit_rxjava_mvp_dagger.ui.gank.presenter.AllPresenter;
 ...
 */
public class AllFragment extends BaseFragment<AllPresenter> implements AllContracts.View, SwipeRefreshLayout.OnRefreshListener {
        ...
        recyclerView.setOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (RecyclerUtils.isSlideToBottom(recyclerView) && !isLoading) {
                    mPresenter.getMoreAll(String.valueOf(++index));
                    isLoading = true;
                }
            }
    ...
    @Override
    public void showAll(List<GankListItemData.ResultsBean> list) {
        adapter.notifyDataChange(list, false);
    }

    @Override
    public void showMoreAll(List<GankListItemData.ResultsBean> list) {
        isLoading = false;
