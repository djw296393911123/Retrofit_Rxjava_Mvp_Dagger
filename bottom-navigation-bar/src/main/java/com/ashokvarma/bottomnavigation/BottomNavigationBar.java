...
//                && oldPosition != -1) {
    ...
    /**
     * Callback interfaces invoked when a tab's selection state changes.
     */
    ...
    /**
     * Simple implementation of the OnTabSelectedListener interfaces with stub implementations of each method.
